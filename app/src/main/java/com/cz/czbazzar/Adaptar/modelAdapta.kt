...
class modelAdapta(var context: Context, var list: ArrayList<Adproductmodel>)
    : RecyclerView.Adapter<modelAdapta.modelViewHolder>() {
    inner class modelViewHolder(view: View):RecyclerView.ViewHolder(view){

        val binding=ModelBinding.bind(view)
    }
    ...
    override fun onBindViewHolder(holder: modelViewHolder, position: Int) {
        ...
        Glide.with(context).load(list[position].productCoverImage).into(holder.binding.pic)
